...
A predictive model build to predict future values of Boston House prices.
Strength of the relationship between each independent variable Xi and Y modeled.
Many times, only a subset of independent variables Xi will have a linear relationship with Y
Figured out which Xi contributes most information to predict Y
